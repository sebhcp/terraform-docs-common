...
| `data.attributes.vcs-repo.tags-regex`         | string  | (nothing) | A regular expression used to match Git tags. When this value is present and a VCS event is received that contains a matching Git tag for the regular expression, a Terraform Cloud run will be triggered.                                                                                                                                                                                                                                                                                                       |
...
| `data.attributes.vcs-repo.tags-regex`         | string         | (previous value) | A regular expression used to match Git tags. When this value is present and a VCS event is received that contains a matching Git tag for the regular expression, a Terraform Cloud run will be triggered.                                                                                                                                                                                   |
